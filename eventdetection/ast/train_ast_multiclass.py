...
for fold in folds:
    ...
    # train_x
    train_x = np.load("data_ast/multiclass/chiseling_" + fold + "/train_x.npy").tolist()
    train_x = train_x + np.load("data_ast/multiclass/drilling_" + fold + "/train_x.npy").tolist()
    train_x = train_x + np.load("data_ast/multiclass/sawing_" + fold + "/train_x.npy").tolist()

    # train_y
    train_y = np.load("data_ast/multiclass/chiseling_" + fold + "/train_y.npy").tolist()
    tmp = np.load("data_ast/multiclass/drilling_" + fold + "/train_y.npy").tolist()
    train_y = train_y + [2 if x == 1 else x for x in tmp]
    tmp = np.load("data_ast/multiclass/sawing_" + fold + "/train_y.npy").tolist()
    train_y = train_y + [3 if x == 1 else x for x in tmp]

    # test_x
    test_x = np.load("data_ast/multiclass/chiseling_" + fold + "/test_x.npy").tolist()
    test_x = test_x + np.load("data_ast/multiclass/drilling_" + fold + "/test_x.npy").tolist()
    test_x = test_x + np.load("data_ast/multiclass/sawing_" + fold + "/test_x.npy").tolist()

    # test_y
    test_y = np.load("data_ast/multiclass/chiseling_" + fold + "/test_y.npy").tolist()
    tmp = np.load("data_ast/multiclass/drilling_" + fold + "/test_y.npy").tolist()
    test_y = test_y + [2 if x == 1 else x for x in tmp]
    tmp = np.load("data_ast/multiclass/sawing_" + fold + "/test_y.npy").tolist()
    ...
    # save best model
    trainer.save_model('runs/best_model_multiclass_' + fold)