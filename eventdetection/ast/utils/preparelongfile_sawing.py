...
# init
root = "F:/SSL/experiment_3d/output/sawing/"
file = "1_010_Movie2D_heatmap.wav"
...
save_path = "F:/datasets/ssl_v2/long_file_sawing_" + filename
...
os.makedirs("../data_ast/sawing_long_" + filename, exist_ok=True)
np.save("../data_ast/sawing_long_" + filename + "/test_y.npy", label)
