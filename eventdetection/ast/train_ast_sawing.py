...
print("loading data")
train_x = np.load("data_ast/sawing_" + fold + "/train_x.npy").tolist()
train_y = np.load("data_ast/sawing_" + fold + "/train_y.npy").tolist()
test_x = np.load("data_ast/sawing_" + fold + "/test_x.npy").tolist()
test_y = np.load("data_ast/sawing_" + fold + "/test_y.npy").tolist()
...
# save best model
trainer.save_model('runs/best_model_sawing_' + fold)