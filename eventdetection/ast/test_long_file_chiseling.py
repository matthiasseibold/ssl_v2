...
# init
root = "F:/datasets/ssl_v2/test_or_noise_50_percent/long_file_chiseling"
files = ["1_015_Movie2D_heatmap",
         "1_016_Movie2D_heatmap"]
fold = "fold1"

# files = ["1_013_Movie2D_heatmap",
#          "1_014_Movie2D_heatmap"]
# fold = "fold2"

# files = ["1_011_Movie2D_heatmap",
#          "1_012_Movie2D_heatmap"]
# fold = "fold3"
...
for count, file in enumerate(files):
    ...
    for i in range(len(y_pred) - 1):
        ...
        if verbose:
            print("Frame number: " + str(i) + " --- Predicted: " + str(y_pred[i]) + " --- Ground Truth: " + str(test_y[i]))
            if cond_gt:
