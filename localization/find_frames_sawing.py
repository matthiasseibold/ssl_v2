...
root_frames = "F:/SSL/experiment_3d/output/sawing/heatmaps/"
...
for f in files:
    ...
    if plot_audio_labels:
        # Load audio file
        audio_file = "F:/SSL/experiment_3d/output/sawing/" + filename + ".wav"
    ...
    if extract_frames:
        ...
        start_time = time_steps[0]  # seconds
        end_time = time_steps[1]  # seconds
